...
$cata = $cata_cuenta->leerDatosInactivos();
            ...
            <div class="row">
                ...
                <div class="span3 well">
                    ...
                    <div class="navbar navbar-inner block-header">
                        <a href="<?php echo INICIO;?>catalogos/catalogocuentas/catalogo_cuentas_lista.php" class="btn btn-success">Regresar lista Cuantas</a>
                    </div>
                    <div class="block-content collapse in"> 
                        ...
                        <td>" . '<a href="catalogo_cuentas_procesar.php?idcuenta='. $id .'&operacion=activar">Activar</a>' . "</td>
                        </tr>";
                            }}else{?>
